...
const Event: React.FC = () => {
    return (
        <div className="py-10 bg-slate-200 text-center">
            <h2 className="mt-8 font-retro text-darkBrown mb-8  text-5xl bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-cyan-900 font-bold">Our Events</h2>
            <div className="grid grid-cols-3 gap-8 justify-center px-32">
                ...
                <div className="album-item p-2 border-4 border-gray-100 rounded-lg shadow-lg">
                    <img src="/e3.jpg" alt="School Visit 1" className="w-full h-64 object-cover rounded-md filter-sepia" />
                    <p className="mt-2 text-sm text-darkBrown font-retro text-center">School Visit 3</p>
                </div>
                <div className="album-item p-2 border-4 border-gray-100 rounded-lg shadow-lg">
                    <img src="/e4.jpg" alt="School Visit 1" className="w-full h-64 object-cover rounded-md filter-sepia" />
                    <p className="mt-2 text-sm text-darkBrown font-retro text-center">School Visit 4</p>
                </div>
                <div className="album-item p-2 border-4 border-gray-100 rounded-lg shadow-lg">
                    <img src="/e5.jpg" alt="School Visit 1" className="w-full h-64 object-cover rounded-md filter-sepia" />
                    <p className="mt-2 text-sm text-darkBrown font-retro text-center">School Visit 5</p>
                </div>
                <div className="album-item p-2 border-4 border-gray-100 rounded-lg shadow-lg">
                    <img src="/e6.jpg" alt="School Visit 1" className="w-full h-64 object-cover rounded-md filter-sepia" />
