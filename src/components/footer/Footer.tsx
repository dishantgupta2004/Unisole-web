            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Unisole is a digital learning platform that offers expert mentorship to young individuals seeking career guidance. The platform focuses on enhancing technological and intellectual skills, helping users reach their full potential.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://facebook.com" className="hover:text-teal-400">
                                <FaFacebookF />
                            </a>
                            <a href="https://twitter.com" className="hover:text-teal-400">
                                <FaTwitter />
                            </a>
                            <a href="https://instagram.com" className="hover:text-teal-400">
                                <FaInstagram />
                            </a>
